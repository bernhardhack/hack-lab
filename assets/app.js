...
en:{
  ...
  waitOn:"Waiting on one thing: how wide the pen is. Nothing can be printed until it is measured.",
  waitWho:"Meanwhile the first drawing is being chosen.",
  nextHead:"Next move",
...
de:{
  ...
  waitOn:"Es fehlt eine Sache: wie dick der Stift ist. Vorher l\u00e4sst sich nichts drucken.",
  waitWho:"Inzwischen wird die erste Zeichnung ausgesucht.",
...
it:{
  ...
  waitOn:"Manca una cosa: quanto \u00e8 larga la penna. Prima non si pu\u00f2 stampare niente.",
  waitWho:"Intanto si sceglie il primo disegno.",
